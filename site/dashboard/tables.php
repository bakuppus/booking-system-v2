      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a class="btn btn-sm btn-outline-primary" href="add-table.php" role="button">Add Table</a>
          </div>
        </div>
      </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <tr>
              ...
              <td><a href="../uploads/<?php echo $row['floor_plan']; ?>"><img src="../uploads/<?php echo $row['floor_plan']; ?>" style="height: 50px; width: 50px;"></a></td>
              <td>&nbsp;<a href="delete-table.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-danger btn-sm">Detele Table</button></a></td>
            </tr>
          </tbody>
          <?php } ?>
        </table>
